...
def call_function(function_call: types.FunctionCall, verbose: bool = False) -> types.Content:
    ...
    try:
        ...
        elif function_name == "make_http_request":
            from func.make_http_request import make_http_request
        ...
        elif function_name == "enumerate_subdomains":
            from func.enumerate_subdomains import enumerate_subdomains
            result = enumerate_subdomains(
                working_directory,
                domain=args.get("domain"),
                method=args.get("method", "dns"),
                wordlist=args.get("wordlist"),
                check_alive=args.get("check_alive", True)
            )
        
        elif function_name == "scan_ports":
            from func.scan_ports import scan_ports
            result = scan_ports(
                working_directory,
                ...
                banner_grab=args.get("banner_grab", True)
            )
